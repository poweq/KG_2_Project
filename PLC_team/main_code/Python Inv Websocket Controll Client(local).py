...
message_sent = False  # 메시지 전송 여부를 추적하는 변수
...
def process_frame(frame):
    """QR 코드 인식을 위한 프레임 처리"""
    global qr_recognition_enabled, message_sent
    ...
    for qr in qr_codes:
        ...
        if not message_sent:
            ...
            message_sent = True  # 메시지 전송 완료 표시
        ...
        time.sleep(10)
        qr_recognition_enabled = True
        message_sent = False  # 10초 후 메시지 전송 가능 상태로 되돌리기
